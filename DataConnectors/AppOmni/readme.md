# Deploy a Function App for collecting AppOmni data into Azure Sentinel
This function app will listen for AppOmni API events and will write them to Log Analyitcs on arrival.
...
<a href="https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2Fgadouryd%2FAzure-Sentinel%2Fmaster%2FDataConnectors%2FAppOmni%2Fazuredeploy.json" target="_blank">
    <img src="https://aka.ms/deploytoazurebutton""/>
</a>

2. Deploy permissions for the function to the Key Vault.

<a href="https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2Fgadouryd%2FAzure-Sentinel%2Fmaster%2FDataConnectors%2FAppOmni%2Fazuredeploy_kv.json" target="_blank">
    <img src="https://aka.ms/deploytoazurebutton""/>
</a>
...
1. Download the [Zip](https://github.com/gadouryd/Azure-Sentinel/blob/master/DataConnectors/AppOmni/appomni_logs_template.zip?raw=true) file of the Azure Funciton app from Github.
...
9. Provide a unique name like "AppOmniLogs". Press Enter.
10. Click Windows.
...
## Configure your AppOmni org.
You also need to configure your AppOmni org to sent events to your Function App. 
1. TBD ~~Select ‘Develop’ in the top right hand corner and click ‘Build App’. 
